...
const outputPath = path.resolve(router.getBasePath(), 'src', './' + user_path + '/stdout.log');
const errorOutputPath = path.resolve(router.getBasePath(), 'src', './' + user_path + '/stderr.log');
